...
# Setting data types
numeric_columns_dtypes: dict[str] = {
...
df.insert(loc=2, column='old_price', value=(df['old_price_in_reais'] + df['old_price_in_cents'] / 100))
df.insert(loc=3, column='new_price', value=(df['new_price_in_reais'] + df['new_price_in_cents'] / 100))
...
if __name__ == '__main__':
    ...
    df.to_sql(con=connection, name='Mercado_Livre_Items', if_exists='replace', index=False)
